# Generated by Django 2.0.1 on 2018-02-14 10:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('representative_picture', models.ImageField(blank=True, null=True, upload_to='')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='species',
            name='synonym_of',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='lepidoptera.Species'),
        ),
        migrations.AddField(
            model_name='genus',
            name='status',
