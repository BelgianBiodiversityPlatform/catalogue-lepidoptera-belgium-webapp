...
def populate_timeperiods(apps):
    _create_timeperiod(apps, 'populate_data/aris.jpg', 'before_1980.jpg', 'Before 1980')
    _create_timeperiod(apps, 'populate_data/aris.jpg', '1980-2004.jpg', '1980-2004')
    _create_timeperiod(apps, 'populate_data/aris.jpg', 'after_2004.jpg', 'After 2004')
